...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // 定义一个工具方法，用于将指定的form表单中所有的输入项转为json数据，格式为：{key:value,key:value}
            ...
            // 条件查询
            $("#btn").click(function () {
                // 将指定的form表单中所有的输入项转为json数据，格式为：{key:value,key:value}
                var i = $("#searchForm").serializeJson();
                // 调用数据表格的 load 方法，重新发送一次 Ajax 请求，并且提交参数
                $("#grid").datagrid("load",i);
                // 关闭查询窗口
...
<!-- 展示区域分布图 -->
<div class="easyui-window" title="分区添加修改" id="showHighCharts" collapsible="false" minimizable="false"
     maximizable="false" style="top:20px;left:200px">
