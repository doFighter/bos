    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnEp").click(function () {
                // alert("修改密码");
                // 进行表单校验
                var e = $("#modifyPassword").form("validate");
                if (e){
                    // 如果表单校验通过，则判断前后两次密码是否一致
        ...
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="modifyPassword">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" data-options="validType:'length[4,6]'" type="Password" class="txt01 easyui-validatebox" required="required"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" data-options="validType:'length[4,6]'" type="Password" class="txt01 easyui-validatebox"  required="required"/></td>
                    </tr>
                </table>
            </form>
        </div>
